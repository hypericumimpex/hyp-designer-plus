<?php
/*
Plugin Name: HYP Designer Plus
Plugin URI: https://github.com/hypericumimpex/hyp-designer-plus/
Description: The Plus Add-On extends the HYP Product Designer with new modules and helpful tools.
Version: 1.2.1
Author: Romeo C.
